...
categories:
  - "Issue 2"
  - "Featured"
description: I am very excited to introduce the second issue of the departmental magazine in my relatively new role as Head of the Department
...
#| echo: FALSE
#| out.width: 50%
#| fig.alt: "Headshot of Gianluca Baio who is a short wavy hair and wearing glasses. He is in a office with a whiteboard and a bookcase in the background."
#| fig.align: center
#| include: false
...
:::{.img-right}
![](photo_HeadofDepartmentGianlucaBaio.png){width="30%"}
:::

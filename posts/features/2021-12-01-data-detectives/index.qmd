...
info:
  author: Nathan Green
  pic: photo_NathanGreen.jpg
  bio: Nathan is a Senior Research Fellow in the Department of Statistical Science at UCL
...
::: {style="float: right;margin-right: 20px;margin-top: -0px;margin-bottom:0px;"}
![](photo_NathanGreen.jpg){width="200px" height="200px"}
:::

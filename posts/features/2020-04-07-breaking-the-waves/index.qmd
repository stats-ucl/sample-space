...
```{r}
#| echo: FALSE
#| fig.alt: "A group of nine men with name tags looking into the camera. Behind them is a woman on the screen connected virtually."
#| fig.align: "center"
...
```{r}
#| echo: FALSE
#| fig.alt: "Two men standing in front of a screen that is much larger than their bodies pointing to a map on the screen."
#| fig.align: "center"
...
```{r}
#| echo: FALSE
#| fig.alt: "A group of men standing what seems to be an end of a seminar. On the background it reads What to Do? Tsunami Safety for Boaters. There is a man receiving flowers from another in the foreground."
#| fig.align: "center"
knitr::include_graphics("group2.png")
```
